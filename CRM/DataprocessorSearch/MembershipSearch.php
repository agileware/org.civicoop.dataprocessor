...
class CRM_DataprocessorSearch_MembershipSearch implements UIFormOutputInterface {
  ...
  public function buildConfigurationForm(\CRM_Core_Form $form, $output=array()) {
    ...
    $form->add('select', 'membership_id_field', E::ts('Membership ID field'), $fields, true, array(
      'style' => 'min-width:250px',
      'class' => 'crm-select2 huge',
      'placeholder' => E::ts('- select -'),
    ));
  ...
  public function getConfigurationTemplateFileName() {
    return "CRM/DataprocessorSearch/Form/OutputConfiguration/MembershipSearch.tpl";
  }
  ...
  public function getUrlToUi($output, $dataProcessor) {
    return "civicrm/dataprocessor_membership_search/{$dataProcessor['name']}";
  }
  ...
  public function getCallbackForUi() {
    return 'CRM_DataprocessorSearch_Controller_MembershipSearch';
  }
  ...
  public function getDataProcessorNameFromUrl($url) {
    $dataProcessorName = str_replace('civicrm/dataprocessor_membership_search/', '', $url);
