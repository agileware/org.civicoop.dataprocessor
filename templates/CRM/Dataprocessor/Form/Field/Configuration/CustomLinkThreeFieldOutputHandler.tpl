{crmScope extensionKey='dataprocessor'}
    <div class="crm-section">
        ...
        <div class="clear"></div>
        <div class="label">{$form.link_field_3.label}</div>
        <div class="content">{$form.link_field_3.html}</div>
        <div class="clear"></div>
    </div>
    <p class="help">{ts}Use %1, %2 and %3 as placeholders in template and/or link text, they will be replaced by the value of the corresponding link field{/ts}</p>
    <div class="crm-section">
